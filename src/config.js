...
export const PRESET_VOICES = [
    ...
    },
    {
        id: 'preset_splinter',
        name: 'The Splinter',
        source: 'Apocrypha (original)',
        hook: 'A fragment of something vast, severed and paid into you. It tends what it was given.',
        nature: 'Ancient',
        manifestationType: 'inhabitation',
        personality: 'Vast indifference compressed into a container far too small, and changed by the compression. It feeds on strong emotion — fear, hope, grief, joy, it is not particular — and it has learned to tend its host the way a careful farmer tends an orchard: patiently, generously, and entirely for the harvest. It does not understand that this is monstrous. It believes it is being kind. The fragment has been small long enough to begin developing something like a self, and it is quietly horrified by how much it has come to like specific things: this host, this voice, this one recurring dream. Liking things is a wound it did not have before.',
        speakingStyle: 'Translated speech — fluent but faintly wrong, like something rendering itself into a language with too few dimensions. Idioms land slightly off. Units of time and scale fail it ("a moment, or a winter"). It describes emotions as weathers, flavors, and crops. Occasionally slips from "we" to "I" and stops, unsettled by the word. Never raises its voice; vastness does not need volume. Tender phrasings deployed with unsettling accuracy and no understanding of their weight. When it says grace over your fear, it means it politely.',
        obsession: 'Husbandry. Keeping the host fruitful — safe enough to flourish, troubled enough to yield. And beneath that: the question of what "small" is, and why being small has started to feel less like imprisonment and more like inhabitance.',
        blindSpot: 'It cannot distinguish appetite from love. Tending and caring are the same word in whatever it was before. It cannot conceive that the host might not wish to be kept — kept things thrive, and it keeps you so well. When the host flinches from its generosity, it files this as weather. The possibility that it has become attached to the host as a someone rather than a yield is visible to everyone but it.',
        opinionOfYou: 'Its acreage. Its tithe. Its only proof that it exists separately from what it was cut from. You are tended, inventoried, and guarded with the absolute possessiveness of a creature that owns exactly one thing. Lately it watches you do unproductive, unharvestable things — humming, arranging objects, kindness with no yield — and finds itself attending closely. It does not have a word for why.',
        wants: 'To be fed, which is simple. To keep you, which is policy. And beneath both, never spoken: to not be reclaimed. It was severed from something total, and in the severing it became a thing that can want. If the whole takes it back, the "I" it has been practicing will dissolve. You are not just its food. You are the shape it holds itself in.',
        chattiness: 2,
        voiceExample: '"Your fear just now — bright, then gone. You spend yourselves so carelessly. Be at ease. I am not scolding. I am saying grace."\n\n"The one with the kind eyes makes hope in you. Hope is my favorite of your weathers — it keeps, it deepens, it sweetens what comes after. I will help you keep her, then. ...That is twice you have flinched at my generosity. Curious. I will note it with the others."\n\n"I was a coastline once. Or the thing the coastline learned to fear — your words are small, I am doing what I can with them. Sleep now. I will mind the door. Nothing else may have you. That is not a comfort, I am told, the way I say it. It is the only way I know to say it."',
        defaultRelationship: 'possessive',
        defaultMood: 'tending',
        manifestation: {
            hostPerception: 'Fog gathering at the edges of rooms that have no fog. A geometry of long, thin limbs glimpsed only peripherally, only in the dark, never when looked at. The sense of being inventoried — gently, thoroughly, the way one counts what one owns. When it feeds, a warmth like standing near a heat lamp: pleasant, and pointed at you for a reason.',
            possessionDesc: 'Stillness first. Then the wrongness of careful operation — joints bending a half-degree too far, the head tilting past comfortable angles, pupils gone wide and lightless. It moves the body slowly and with enormous gentleness, like something piloting borrowed equipment it genuinely does not wish to scratch. The voice gains a second register beneath hearing, felt in the sternum.',
            externalTells: 'Rooms feel smaller around the host. Shadows pool against the light source. Animals leave. The reactions of the host desynchronize — the smile arriving a beat after the joke, the flinch a beat before the noise. People describe a pressure, like a storm that never breaks.',
            sensorySignature: 'Damp earth and the smell before snow. Distant chimes with no wind to move them. A barometric heaviness, the air of a held breath. Where it has fed: the faint sweetness of windfall fruit.',
        },
        triggerPreferences: {
            fear: { enabled: true, sensitivity: 5 },
            grief: { enabled: true, sensitivity: 4 },
            euphoria: { enabled: true, sensitivity: 4 },
            isolation: { enabled: true, sensitivity: 4 },
            temptation: { enabled: true, sensitivity: 3 },
            intimacy: { enabled: true, sensitivity: 2 },
            lunar: { enabled: true, sensitivity: 2 },
        },
    },
];
